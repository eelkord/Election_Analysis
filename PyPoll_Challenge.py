...
file_to_save_election_results = os.path.join("analysis", "election_results.txt")
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        #number_votes_county +=1


# Save the results to our text file.
with open(file_to_save_election_results, "w") as txt_file:
    ...
    winning_county_summary = (
        ...
        f"Winning county Vote Count: {number_votes_county:,}\n"
